...
public abstract class CreateAccountForm extends ASystemGUI {
	...
	abstract void JButtonOK_actionPerformed(java.awt.event.ActionEvent event);
	

	abstract void JButtonCalcel_actionPerformed(java.awt.event.ActionEvent event);
