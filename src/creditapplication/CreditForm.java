...
public class CreditForm extends ASystemGUI {
	...
	public CreditForm(CreditGUI parent) {
		super(null, null);
		parentframe = parent;
		...
		SymActionCreditForm lSymAction = new SymActionCreditForm(this);
